...
import { colors, fontSizes } from "~/layouts/main/sidebar/util/conxt";
import { useEffect, useState } from "react";

export default function Appearnce({close}){
    ...
    return(
        <div className="w-[600px]">
            <h3 className="mt-8 mb-3 text-[23px] leading-7 font-extrabold  text-center">Gürünümü özeleştir</h3>
            <div className="p-8 pt-0">
                <p className="text-center leadin-5 text-[color:var(--color-bases)] text-[15px] mb-5">
                ...
                <div className="mx-8 mb-4">
					<div className="border  border-[color:var(--background-third)] px-4 flex py-3 gap-3 rounded-2xl">
						...
						<div className="flex-1 flex flex-col">
							<header className="mb-0.5 leading-5 flex items-center">
								...
								<div className="ml-1 flex items-center text-[color:var(--color-bases)]">
									@X · 31d
								</div>
							</header>
							<div className="text-[color:var(--color-base)] leading-5">
								...
								bağlantılar, metinler, etiketler ve <Link className="text-[color:var(--color-primary)] hover:underline"
					...
					<div className="grid gap-2">
						...
						<div className="bg-[color:var(--background-secondary)] p-4 rounded-2xl flex gap-4 flex items-center  justify-center">
							<div className="text-[13px]">
								aA
							</div>
							<div className=" bg-[color:var(--color-secondary)] h-1  flex-1 rounded-full relative">
					...
					<h6 className="text-[color:var(--color-bases)] text-[13px] mb-1 leading-5 font-bold">Arka Plan</h6>
