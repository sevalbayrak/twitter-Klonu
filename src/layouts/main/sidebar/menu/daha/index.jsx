...
import { setModal } from "~/store/auth copy/actions";

export default function Daha(){
    return(<Popover className='relative   text-[color:var(--color-base)]'>
    ...
    <div className="w-[1.641rem] h-[1.641rem] relative">
     ...
     <Popover.Panel className='w-[318px] absolute  shadow-box bottom-0 left-0   bg-[color:var(--background-primary)] rounded-xl '>
    ...
    <div className="w-[26.25] h-[26.25] relative">
     ...
     {({open})=>(
      ...
      <Disclosure.Panel>
      <Link to='/' className="   flex  text-[15px] font-miunim items-center px-3 h-11 gap-3 hover:bg-[color:var(--background-secondary)] font-bold ">
        <svg viewBox="0 0 24 24" width={18.75} height={18.75}>
        <path fill="currentcolor" d="M8.75 21V3h2v18h-2zM18 21V8.5h2V21h-2zM4 21l.004-10h2L6 21H4zm9.248 0v-7h2v7h-2zz"/>
      </svg>
      İstatislikler
    ...
    <Disclosure>
      ...
      <Disclosure.Panel >
      <Link to='/' className="   flex  text-[15px] font-miunim hover:bg-[color:var(--background-secondary)] items-center px-3 h-11 gap-3  font-bold ">
        <svg viewBox="0 0 24 24" width={18.75} height={18.75}>
    ...
    <Disclosure>
     ...
     Ayarlar ve Destek
      ...
      className="   flex  w-full text-[15px] font-miunim items-center px-3 h-11 gap-3 hover:bg-[color:var(--background-secondary)] font-bold ">
        <svg viewBox="0 0 24 24" width={18.75} height={18.75}>
