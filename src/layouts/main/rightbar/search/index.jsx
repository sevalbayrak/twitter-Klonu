...
export default function Search(){
    ...
    const [yaziSil ,setYaziSil] = useState('');
    const [focus, setFocus] = useState(false)
    return(
        <div className="min-h-[32px] h-[53px] mb-3 flex items-center relative " ref={ref}>
       ...
       <div className="w-[3.5rem] h-full flex  items-center justify-center absolute top-0 left-0 pointer-events-none">
            ...
            <svg viewBox="0 0 24 24"  height={18.75}className="min-w-[32px] text-[color:var(--color-bases)] group-focus-within:text-[color:var(--color-primary)] absolute">
            ...
            <input placeholder="Ara" type="text" value={yaziSil} onChange={e => setYaziSil(e.target.value)} onFocus={() => setFocus(true)}
        ...
        {focus && (
				<div
                className="absolute w-[350px] top-full -left-px -translate-y-px bg-[color:var(--background-primary)] shadow-box max-h-[calc(80vh-53px)] rounded-lg text-center min-h-[100px]">
                <p className="p-3 pt-5 text-[#] leading-5">
